...
module.exports = class SetBirthdayCommand extends Command {
  ...
  async run(message: Message, args: Args) {
    ...
    if (didDateChange(birthday, day.value, month as number, year.value)) {
      const embed = new BediEmbed().setColor(colors.ERROR).setTitle('Set Birthday Reply').setDescription('That date is invalid!');
    ...
    // Normally you would need to check that the person who clicked was the author of the original command, but this takes place
    // in a DM
