...
module.exports = class SettingsCommand extends Command {
  ...
  async run(message: Message, args: Args) {
    ...
    const embed =
	new BediEmbed().setTitle('Toggle Modules Reply').setDescription('Select a module and then choose to enable or disable');
	...
	const embed =
	    new BediEmbed().setTitle('Toggle Module Reply').setColor(colors.ERROR).setDescription('You did not run this command');
