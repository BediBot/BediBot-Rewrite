        ...
        async run(message: Message, args: Args) {
                ...
                if (!module.success) {
                            ...
                            .setDescription(
                                ...
                                `\n\nRun ${
                                    Formatters.inlineCode(
                                        settingsData.prefix + 'toggleModules')} to enable or disable any specific module` +
                                `\nRun ${
                                    Formatters.inlineCode(settingsData.prefix + 'help')} to view commands to update settings` +
                        ...
                        embed.setDescription(
                            'Here are the settings for the `' + capFirstLetterEveryWord(module.value) + '` module');
                        ...
                        switch (module.value.toLowerCase()) {
                                ...
                                case 'quotes':
                                        embed.addField('Quotes Enabled', '`' + settingsData.quotesEnabled + '`', false)
                                            .addField(
                                                'Number of Approvals Required to Save',
                                                '`' + settingsData.quoteApprovalsRequired + '`', false);
                                        break;
                                case 'pins':
                                ...
                                default:
                                        embed.setColor('RED');
                                        embed.setDescription(
                                            'That is not a valid module! Run `' + settingsData.prefix +
                                            'settings` to see a list of valid modules.');
                        }
                }
