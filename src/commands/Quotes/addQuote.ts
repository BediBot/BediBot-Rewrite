...
module.exports = class AddQuoteCommand extends Command {
        ...
        async run(message: Message, args: Args) {
                ...
                collector.on('collect', async interaction => {
                        ...
                        collector
                            .resetTimer();  // If someone interacts, reset the timer to give more time for approvals to come in
                        ...
                        if (numApprovals < settingsData.quoteApprovalsRequired) {
                                ...
                                await addQuote(
                                    interaction.guildId as string, quote as string, quoteAuthor.value!.toString(), date);
